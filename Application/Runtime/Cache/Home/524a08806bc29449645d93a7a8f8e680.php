...
<meta name="author" content="DeathGhost"/>
 <script type="text/javascript">
            var t="<?php echo ($errinfo); ?>";
            if(t.length !==0){
               alert("<?php echo ($errinfo); ?>");
            }
	</script>
</head>
<body>
...
<section class="Psection MT20">
 <form method="post" action="<?php echo U('Login/doregister','','');?>">
...
<!--  <tr>
  ...
  <td><input type="text" name="captcha" required><img src="/zuoan/index.php/Home/Login/captchaImg" style="margin-left:8px; vertical-align:bottom" width="83" height="36"alt="看不清？点击更换" title="点我更换验证码" id='verify-img'
                             onclick="this.src = '/zuoan/index.php/Home/Login/captchaImg?' + Math.random();"></td>
  </tr>-->
  <tr>
  <td width="40%" align="right"></td>
  <td><input type="submit" name="" class="Submit_b" value="注 册">( 已经是会员，<a href="/zuoan/index.php/Home/Login/index" class="BlueA">请登录</a> )</td>
  </tr>
  </table>
 </form>
</section>
