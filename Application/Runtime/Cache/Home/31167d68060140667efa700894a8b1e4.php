...
<html>
    <head>
        ...
        <script>
            if (<?php echo ($datamess); ?> == 123) {
                alert('您还未登录，请先登录后查看购物车');
            ...
            <div class="gwc" style=" margin:auto;">
                ...
                <?php if(is_array($shopdata)): $k = 0; $__LIST__ = $shopdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><table cellpadding="0" cellspacing="0" class="gwc_tb2" id="table<?php echo ($k); ?>">
                        <tr>
                            ...
                            <td class="tb2_td3"><a id="cname" href="detailsp.html" target="_blank"><?php echo ($vo["sc_foodname"]); ?></a></td>
                            ...
                            <td class="tb1_td5">
                                <input id="min<?php echo ($k); ?>" name=""  style="width:30px; height:30px;border:1px solid #ccc;" type="button" value="-" />
                                <input id="text_box<?php echo ($k); ?>" name="foodcount" type="number" value="<?php echo ($vo["sc_count"]); ?>" style=" width:40px;height:28px; text-align:center; border:1px solid #ccc;" />
                            ...
                            <td class="tb1_td7"><a href="javascript:void(0);" id="delcart1" name="" onclick="cdelete('<?php echo ($vo["sc_foodname"]); ?>');">删除</a></td>
                        </tr>
                ...
                <table cellpadding="0" cellspacing="0" class="gwc_tb3">
                    <tr>
                        ...
                        <td class="tb3_td1"><input id="invert" type="checkbox" />
                            ...
                            取消 </td>
                        <td class="tb3_td2 GoBack_Buy Font14"><a href="/zuoan/index.php/Home/index/index" target="_blank">继续购物</a></td>
                        ...
                        <td class="tb3_td4"><span id="jz1">结算</span><a href="javascript:void(0);"onclick="chem()" style=" display:none;"class="jz2" id="jz2">结算</a></td>
                    </tr>
                </table>
            </div>
        </form>
...
//                var totalxb;
                $(".gwc_tb2 input[name=newslist]").each(function () {
                    if ($(this).is(":checked") == true) {
                        a = $(this).parent().next().next().children().html();
                        vb = $(this).parent().next().next().next().next().children().next().val();
                        totalcout.push(a+":"+vb);
                        count = count + "'" + a + "'" + ',';
                    }
                });
                if (count != '') {
                    ...
                    window.location.href = '/zuoan/index.php/Home/System/confirm_order?count=' + totalcout + '';
                } else {
                    alert("请选择一项购物后结算");
                }
            }
